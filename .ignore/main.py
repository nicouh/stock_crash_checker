...
unemployment_claims_url = 'https://api.stlouisfed.org/fred/series/observations?series_id=ICSA&api_key=YOUR_FRED_API_KEY&file_type=json'
...
app.layout = html.Div([
    ...
    dcc.Interval(
        ...
        interval=24*60*60*1000,  # Refresh daily
        n_intervals=0
    )
])
